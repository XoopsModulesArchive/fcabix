...
// Set the template
$xoopsOption['template_main'] = 'fcabix_modfolder.html';    
...
if (if_folder_exist($current_dir) && have_access_right_to_folder($current_dir) && have_mod_right_to_folder($current_dir) && (is_not_hidden($current_dir) || $is_mod_admin)) {
	...
	$tpl_vars['content']['folder_name'] = $myrow['folders_name'];
...
$tpl_vars['langs'] = array(
	...
	'modfolder_title' => _MD_MODFOLDER_TITLE,
	'modfolder_input' => sprintf(_MD_MODFOLDER_INPUT, $myrow['folders_name']),
	'modfolder_rename' => _MD_MODFOLDER_RENAME
);
